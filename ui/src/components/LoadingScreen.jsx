// Initial loading screen shown while the app boots.
// Animation: Uiverse.io by Juanes200122 (inline SVG + CSS below in index.css).
  ...
  return (
    <div className={`loading-screen ${visible ? '' : 'hidden'}`} aria-hidden={!visible}>
      <div className="loading-inner">
        ...
        <div className="loading-brand">NIRA</div>
      </div>
    </div>
  )
}
