...
export const SLASH_COMMANDS = [
  ...
  { cmd: 'spotify', tool: 'spotify', icon: '🎵', label: 'Search Spotify',
    hint: 'e.g. /spotify toxic Britney Spears', arg: (t) => ({ query: t }) },
  { cmd: 'email', tool: 'gmail', icon: '📧', label: 'Check Gmail',
    hint: 'e.g. /email or /email is:unread', arg: (t) => ({ query: t }) },
  { cmd: 'google', tool: 'google', icon: '🔍', label: 'Google account info',
    hint: '/google', arg: () => ({}) },
